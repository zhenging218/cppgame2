...
function(postbuild)
    if(NOT EXISTS "${ASSET_SYMLINK_LOCATION}")
        ...
        if(${ALWAYS_COPY})
            ...
            get_filename_component(actual_path "${ASSET_SYMLINK_LOCATION}" REALPATH)
            if(${actual_path} STREQUAL "${ASSET_SRC_LOCATION}")
                message(STATUS "[${ASSET_SYMLINK_LOCATION}] is up-to-date.")
            else()
                message(STATUS "symlink [${ASSET_SYMLINK_LOCATION}] is pointing to the wrong directory [${actual_path}], should be [${ASSET_SRC_LOCATION}]. recreating...")
                file(REMOVE "${ASSET_SYMLINK_LOCATION}")
                symlink_assets()
            endif()
